...
def trainData():
    ...
    validation_x = muscle_activation[training_range_lower_bound:training_range_upper_bound]
    validation_y = f_out[training_range_lower_bound:training_range_upper_bound]
